  ...
  <section class="sidebar">
    ...
    <div class="user-panel">
      <div class="pull-left image">
        <img src="<?php echo base_url('assets/uploads/images/astronaut.svg'); ?>" class="img-circle">
      </div>
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <?php if ($this->session->userdata('user')['role'] === 'admin') : ?>
        ...
        <li><a href="<?= base_url('gaji/index') ?>"><i class="fa fa-dollar"></i> <span>Salary</span></a></li>
